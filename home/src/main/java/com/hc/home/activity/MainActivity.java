...
import com.hc.home.fragment.GiftFragment;
import com.hc.home.fragment.MainFragment;
import com.hc.home.fragment.ShareFragment;


public class MainActivity extends AppCompatActivity {
	private DrawerLayout mDrawerLayout;//左侧菜单栏
	...
	private void initLeftMenu() {
		...
		tvLogin = (TextView) findViewById(R.id.tv_user_name);
		...
		header.setOnClickListener(onLeftMenuClickListener);
		tvLogin.setOnClickListener(onLeftMenuClickListener);
